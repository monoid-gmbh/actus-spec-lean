...
\begin{theorem}[Rate cap/floor bound]\label{thm:rate-bound}
        \lean{Actus.Contract.Lending.Properties.pam_rr_rate_mem,
              Actus.Contract.Lending.Properties.ann_rr_rate_mem,
              Actus.Contract.Lending.Properties.clamp_mem}
...
\begin{theorem}[Redemption non-overshoot]\label{thm:no-overshoot}
        \lean{Actus.Contract.Lending.Properties.redeemed_no_overshoot,
              Actus.Contract.Lending.Properties.lam_pr_nt_mem,
              Actus.Contract.Lending.Properties.redeemed_abs_le}
        \uses{def:amortizers}
        \leanok
...
\begin{theorem}[Strict amortization and full repayment]\label{thm:amortization}
        \lean{Actus.Contract.Lending.Properties.lam_pr_nt_lt,
              Actus.Contract.Lending.Properties.lam_pr_full_repay}
...
\begin{theorem}[Interest capitalization conserves value]\label{thm:ipci}
        \lean{Actus.Contract.Lending.Properties.pam_ipci_capitalizes}
        \uses{def:pam-stf}
        \leanok
...
\begin{definition}[Principal-redemption trace]\label{def:prtrace}
        \lean{Actus.Contract.Lending.Properties.PRTrace}
        \uses{def:amortizers}
        \leanok
...
\begin{theorem}[Trace-level conservation of the notional]\label{thm:conservation}
        \lean{Actus.Contract.Lending.Properties.prTrace_nt_mem,
              Actus.Contract.Lending.Properties.prTrace_abs_le,
              Actus.Contract.Lending.Properties.prTrace_isTrace}
